...
const EVENTS = [
  ...
  },
  {
    ...
    description:
      "ALGOSPHERE'25, presented by AIvolutions × DataAnalytix, was MAIT's AI & Data Analytics hackathon, bringing together 24 students across AI&DS, CSE-AI, and CSE-DS for a multi-round challenge in innovative thinking and real-world problem-solving.\n\nRegistrations closed on 12th March 2025, followed by a preliminary round on 22nd March testing conceptual clarity and analytical thinking. The final round, held in the first week of April, saw shortlisted teams present fully developed solutions in Ethical AI, Smart Systems, and Data-Centric Innovation through live coding and real-time presentations, guided by dedicated mentors and evaluated live by a panel of expert judges.\n\nWith a prize pool of ₹6,000+, winning teams were recognized for innovation, technical execution, and collaborative spirit. The event was made possible by faculty coordinators Dr. Anshu Khurana, Mr. Nitish Uppal, Dr. Nitin Garg, and Ms. Tina Dudeja, under the guidance of Dr. Vinay Kumar Saini, Head of the CSE-AI & DS Department.",
  ...
  },
  {
    ...
    description:
      "On 25th November 2024, AIvolutions hosted \"Metaverse — Game Development\", bringing together tech enthusiasts, coders, and gamers for an interactive deep dive into game development and immersive virtual environments.\n\nDr. Vinay Kumar Saini opened the session emphasizing hands-on learning and the integration of AI with next-generation technologies. Participants were then introduced to game design principles, animation and interactive graphics basics, and AI's role in adaptive game environments — including a live walkthrough of a Metaverse-based virtual world.\n\nThe hands-on portion had teams collaborating on creative ideas and playing games together in real time, reinforcing the session's blend of learning and play. The event was guided by faculty coordinators Dr. Nitin Garg, Ms. Tina Dudeja, and Dr. Anshu Khurana, and organized by the AIVOLUTIONARIES core team.",
  ...
  },
  {
    ...
    description:
      "On 20th February 2025, AIvolutions hosted \"Introduction to Enterprise Application Suite\", an industry session on Enterprise Resource Planning (ERP) software featuring a guest speaker from STMicroelectronics, a global technology company.\n\nKeynote speaker Ms. Parul Mehndiratta, Business Enterprise Architect at STMicroelectronics, walked students through ERP fundamentals and architecture, its role in managing finance, HR, and supply chain, the shift toward cloud-based and AI-integrated ERP, and real-world examples of how multinational corporations deploy these systems at scale — along with career guidance for students eyeing the enterprise software domain.\n\nAn open Q&A followed, and all attendees received participation certificates and AIvolutions membership access. The session was organized under the guidance of Dr. Vinay Kumar Saini, with support from Dr. Nitin Garg, Dr. Nitish Uppal, Ms. Tina Dudeja, and Dr. Anshu Khurana.",
  ...
  },
  {
    ...
    description:
      "On 18th October 2024, students from MAIT's Department of Artificial Intelligence visited DUCAT Pitampura, a premier IT training institute, to explore real-world applications of AI — including Machine Learning, Computer Vision, Deep Learning, and Natural Language Processing.\n\nThe session opened with a deep dive into ML (supervised/unsupervised learning), Computer Vision (CNNs, object detection), Deep Learning, and NLP (chatbots, sentiment analysis). Students then split into teams for a hands-on, real-time problem-solving challenge, applying the concepts they'd just learned to a live problem statement.\n\nEach team presented their solutions to DUCAT trainers and industry experts, receiving feedback on algorithm accuracy, deployment practices, and scalability — bridging classroom theory with industry expectations. The visit was made possible through the guidance of Dr. Vinay Kumar Saini and Dr. Nitin Garg.",
  ...
  },
  {
    ...
    description:
      "Held on 29th September 2024, the AIvolutions Orientation Event marked the beginning of a new chapter for the AI society at MAIT — welcoming new members, introducing the core team, and sharing the society's vision for the year ahead.\n\nDr. Vinay Saini, Head of the AI & DS Department, opened with an address on hands-on learning and industry exposure, followed by the core team unveiling the year's lineup: AI hackathons, \"Code in the Dark\" coding competitions, technical workshops (including a special Microsoft session), and robotics/AI integration projects. Guest speaker Ms. Tushika (Founder, 15FORTEEN) shared strategies for balancing academics with co-curricular pursuits, and senior member Jinal Gupta spoke about her own growth through the society.\n\nThe event closed with an open Q&A and a strong foundation set for the year, leaving new members clear on the society's goals and inspired to get involved.",
  ...
  },
  {
    ...
    description:
      "On 27th May 2025, AIvolutions, in collaboration with DataAnalytix, conducted an exclusive webinar titled \"Preparation Mantra — Unlock Your Exam Success!\" to help students navigate end-semester exams with practical, effective strategies.\n\nThe session was led by Jinal Gupta, a senior AIvolutions member known for balancing academic excellence with co-curricular activity. She covered smart exam preparation tips, effective time management, maintaining a strong CGPA through consistent performance, and pro techniques for attempting different question types under time pressure.\n\nThe webinar left students equipped with tools to approach their examinations with confidence, and reflected AIvolutions' ongoing commitment to supporting academic growth alongside technical learning.",
      ...
      >
        ...
        >
          ...
          <div className="bg-surface">
            ...
            <h2 className="text-2xl md:text-3xl font-display font-bold text-white uppercase tracking-tight text-center py-6 px-6">
              {event.title}
            </h2>
          </div>
          ...
          <div className="bg-surface/30 p-6 md:p-10">
            {event.description && (
              <div className="max-w-2xl mx-auto border-l-2 border-primary/70 pl-6 md:pl-8">
                {event.description.split("\n\n").map((para, idx) => (
                  <p
                    key={idx}
                    className="text-sm md:text-[15px] text-white/70 font-sans leading-[1.9] tracking-wide mb-5 last:mb-0"
                  >
                    {para}
                  </p>
                ))}
